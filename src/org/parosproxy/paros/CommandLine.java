...
public class CommandLine {
    ...
    /**
     *  store command option and values if that command exists
     *   
     * @param args			Command Line List 
     * @param paramName		Command want to check 
     * @param i				Index
     * @return				is command exist?
     */
    ...
    /** 
     *  Check whether there command exist or not.
     *  
     * @param args			Command Line List 
     * @param paramName		Command want to check 
     * @param i				Index
...
//        }
	...
	/** 
	 * check mode is GUI or not from input arguments (commands)
	 * if NEW_SESSION or SESSION command exists in arguments
	 * then mode is terminal mode.
	 *  
	 * @param args			command list
	 * @param i				Index
	 * @return				is exists NEW_SESSION or SESSION command?
	 */
